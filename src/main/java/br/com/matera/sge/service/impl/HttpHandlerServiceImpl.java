...
//        final String content = "{\"sendSmsResponse\" : {\"statusCode\" : \"00\",\"statusDescription\" : \"Ok\",\"detailCode\" : \"000\",\"detailDescription\" : \"Message Sent\"}}";
        return content;
    ...
    private String extractToString(final InputStream inputStream) throws IOException {
