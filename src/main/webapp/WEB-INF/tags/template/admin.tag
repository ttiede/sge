        ...
        <ul class="nav navbar-nav">
          <li class="dropdown">
            ...
            <ul class="dropdown-menu">
	            	              <li><a href="<c:url value='/email/form'/>"><span class="glyphicon glyphicon-plus-sign"></span> Add email</a></li>	              
	              <li><a href="<c:url value='/email'/>"><span class="glyphicon glyphicon-menu-hamburger"></span> List email</a></li>
